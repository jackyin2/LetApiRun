...
if __name__ == "__main__":
    # 1 idel执行
    # main(path="E:\jackstudy\LetApiRun\data\Dface", file="E:\jackstudy\LetApiRun\data\Dface\菜单管理\\test_patch_edit_face.json")
    ...
    parser.add_argument("-f", "--file", help="测试文件", type=str)
    ...
    if not is_path(args.dir) or not is_path(args.file):
        print("dir or file is not a true path? ")
        exit(0)
    elif not is_dir(args.dir):
